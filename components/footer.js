	...
	<footer>
		<div className="widthContainer">
			...
			<div className="description">
				<h4>
					Collectif d’étudiants, qui regroupe l’ensemble des filières de HETIC. Indépendant, il se propose de raconter ce qui fait l’expérience des héticiens.<br/>Pour nous contacter: <strong><a href="mailto:info@heticiens.news">info@heticiens.news</a></strong>.
				</h4>
			</div>
			<div className="links">
				<h3>Suivez-nous:</h3>
